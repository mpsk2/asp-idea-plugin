...
public class ASPPythonCodeStatementImpl extends ASPStatementImpl implements ASPPythonCodeStatement {

    public ASPPythonCodeStatementImpl(ASTNode node) {
        super(node);
    }

    public void accept(@NotNull ASPVisitor visitor) {
        visitor.visitPythonCodeStatement(this);
    }
