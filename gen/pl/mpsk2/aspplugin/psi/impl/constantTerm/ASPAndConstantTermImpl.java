...
public class ASPAndConstantTermImpl extends ASPBinaryConstantTermImpl implements ASPAndConstantTerm {

  public ASPAndConstantTermImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ASPVisitor visitor) {
    visitor.visitAndConstantTerm(this);
  }
