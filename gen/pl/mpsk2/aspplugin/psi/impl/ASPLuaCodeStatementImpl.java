...
public class ASPLuaCodeStatementImpl extends ASPStatementImpl implements ASPLuaCodeStatement {

    public ASPLuaCodeStatementImpl(ASTNode node) {
        super(node);
    }

    public void accept(@NotNull ASPVisitor visitor) {
        visitor.visitLuaCodeStatement(this);
    }
