...
import pl.mpsk2.aspplugin.psi.ASPDisjoint_;

public class ASPDisjointStatementImpl extends ASPStatementImpl implements ASPDisjointStatement {

    public ASPDisjointStatementImpl(ASTNode node) {
        super(node);
    }

    public void accept(@NotNull ASPVisitor visitor) {
        visitor.visitDisjointStatement(this);
    }
    ...
    public ASPDisjoint_ getDisjoint_() {
        return findNotNullChildByClass(ASPDisjoint_.class);
    }
