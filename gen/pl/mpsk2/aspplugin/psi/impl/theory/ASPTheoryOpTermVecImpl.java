...
public class ASPTheoryOpTermVecImpl extends ASPCompositeElementImpl implements ASPTheoryOpTermVec {

    public ASPTheoryOpTermVecImpl(ASTNode node) {
        super(node);
    }

    public void accept(@NotNull ASPVisitor visitor) {
        visitor.visitTheoryOpTermVec(this);
    }
