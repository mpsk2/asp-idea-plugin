...
public class ASPNOptConditionImpl extends ASPCompositeElementImpl implements ASPNOptCondition {

    public ASPNOptConditionImpl(ASTNode node) {
        super(node);
    }

    public void accept(@NotNull ASPVisitor visitor) {
        visitor.visitNOptCondition(this);
    }
