...
public class ASPQuestionTermImpl extends ASPBinaryTermImpl implements ASPQuestionTerm {

    public ASPQuestionTermImpl(ASTNode node) {
        super(node);
    }

    public void accept(@NotNull ASPVisitor visitor) {
        visitor.visitQuestionTerm(this);
    }
