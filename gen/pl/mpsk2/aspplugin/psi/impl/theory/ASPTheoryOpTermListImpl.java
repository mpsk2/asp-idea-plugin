...
public class ASPTheoryOpTermListImpl extends ASPCompositeElementImpl implements ASPTheoryOpTermList {

    public ASPTheoryOpTermListImpl(ASTNode node) {
        super(node);
    }

    public void accept(@NotNull ASPVisitor visitor) {
        visitor.visitTheoryOpTermList(this);
    }
    ...
    @Override
    @NotNull
    public List<ASPTheoryOpTermVec> getTheoryOpTermVecList() {
        return ASPPsiTreeUtil.getChildrenOfTypeAsList(this, ASPTheoryOpTermVec.class);
    }
