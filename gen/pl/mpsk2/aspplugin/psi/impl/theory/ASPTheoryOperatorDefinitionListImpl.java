...
public class ASPTheoryOperatorDefinitionListImpl extends ASPCompositeElementImpl implements ASPTheoryOperatorDefinitionList {

    public ASPTheoryOperatorDefinitionListImpl(ASTNode node) {
        super(node);
    }

    public void accept(@NotNull ASPVisitor visitor) {
        visitor.visitTheoryOperatorDefinitionList(this);
    }
    ...
    @Override
    @NotNull
    public List<ASPTheoryOperatorDefinition> getTheoryOperatorDefinitionList() {
        return ASPPsiTreeUtil.getChildrenOfTypeAsList(this, ASPTheoryOperatorDefinition.class);
    }
