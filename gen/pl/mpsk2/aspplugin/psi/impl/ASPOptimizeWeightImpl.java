...
public class ASPOptimizeWeightImpl extends ASPCompositeElementImpl implements ASPOptimizeWeight {

    public ASPOptimizeWeightImpl(ASTNode node) {
        super(node);
    }

    public void accept(@NotNull ASPVisitor visitor) {
        visitor.visitOptimizeWeight(this);
    }
    ...
    public ASPNTermVec getNTermVec() {
        return findChildByClass(ASPNTermVec.class);
    }
