...
import pl.mpsk2.aspplugin.psi.ASPConstant;
import pl.mpsk2.aspplugin.psi.ASPIdentifier;

public class ASPConstTermImpl extends ASPTermImpl implements ASPConstTerm {

    public ASPConstTermImpl(ASTNode node) {
        super(node);
    }

    public void accept(@NotNull ASPVisitor visitor) {
        visitor.visitConstTerm(this);
    }
    ...
    @Override
    @Nullable
    public ASPConstant getConstant() {
        return findChildByClass(ASPConstant.class);
    }
    ...
    @Override
    @Nullable
    public PsiElement getAnonymous() {
        return findChildByType(ANONYMOUS);
    }
