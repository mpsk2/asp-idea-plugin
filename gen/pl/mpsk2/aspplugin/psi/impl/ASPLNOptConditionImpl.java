...
public class ASPLNOptConditionImpl extends ASPCompositeElementImpl implements ASPLNOptCondition {

    public ASPLNOptConditionImpl(ASTNode node) {
        super(node);
    }

    public void accept(@NotNull ASPVisitor visitor) {
        visitor.visitLNOptCondition(this);
    }
    ...
    @Override
    @NotNull
    public ASPNOptCondition getNOptCondition() {
        return findNotNullChildByClass(ASPNOptCondition.class);
    }
