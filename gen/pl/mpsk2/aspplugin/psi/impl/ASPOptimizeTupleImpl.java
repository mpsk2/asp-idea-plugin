...
public class ASPOptimizeTupleImpl extends ASPCompositeElementImpl implements ASPOptimizeTuple {

    public ASPOptimizeTupleImpl(ASTNode node) {
        super(node);
    }

    public void accept(@NotNull ASPVisitor visitor) {
        visitor.visitOptimizeTuple(this);
    }
    ...
    @Override
    @NotNull
    public ASPNTermVec getNTermVec() {
        return findNotNullChildByClass(ASPNTermVec.class);
    }
