...
import pl.mpsk2.aspplugin.psi.ASPMaxMinList;

public class ASPMaximizeStatementImpl extends ASPStatementImpl implements ASPMaximizeStatement {

    public ASPMaximizeStatementImpl(ASTNode node) {
        super(node);
    }

    public void accept(@NotNull ASPVisitor visitor) {
        visitor.visitMaximizeStatement(this);
    }
    ...
    @Override
    @NotNull
    public PsiElement getMaximize() {
        return findNotNullChildByType(MAXIMIZE);
    }
