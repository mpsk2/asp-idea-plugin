...
public class ASPTheoryOpTermImpl extends ASPTermImpl implements ASPTheoryOpTerm {

    public ASPTheoryOpTermImpl(ASTNode node) {
        super(node);
    }

    public void accept(@NotNull ASPVisitor visitor) {
        visitor.visitTheoryOpTerm(this);
    }
    ...
    @Override
    @NotNull
    public ASPTheoryTerm getTheoryTerm() {
        return findNotNullChildByClass(ASPTheoryTerm.class);
    }
