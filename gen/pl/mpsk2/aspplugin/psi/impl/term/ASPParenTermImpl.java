...
import pl.mpsk2.aspplugin.psi.ASPTermVec;

public class ASPParenTermImpl extends ASPTermImpl implements ASPParenTerm {

    public ASPParenTermImpl(ASTNode node) {
        super(node);
    }
    ...
    public ASPTermVec getTermVec() {
        return findChildByClass(ASPTermVec.class);
    }
