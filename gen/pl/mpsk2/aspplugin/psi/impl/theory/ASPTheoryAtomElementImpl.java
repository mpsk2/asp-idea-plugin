...
public class ASPTheoryAtomElementImpl extends ASPCompositeElementImpl implements ASPTheoryAtomElement {

    public ASPTheoryAtomElementImpl(ASTNode node) {
        super(node);
    }

    public void accept(@NotNull ASPVisitor visitor) {
        visitor.visitTheoryAtomElement(this);
    }
    ...
    public ASPOptCondition getOptCondition() {
        return findChildByClass(ASPOptCondition.class);
    }

    @Override
    @Nullable
    public ASPTheoryOpTermList getTheoryOpTermList() {
        return findChildByClass(ASPTheoryOpTermList.class);
    }
