...
public class ASPNLitVecImpl extends ASPCompositeElementImpl implements ASPNLitVec {

  public ASPNLitVecImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ASPVisitor visitor) {
    visitor.visitNLitVec(this);
  }
  ...
  @Override
  @NotNull
  public List<ASPLiteral> getLiteralList() {
    return ASPPsiTreeUtil.getChildrenOfTypeAsList(this, ASPLiteral.class);
  }
