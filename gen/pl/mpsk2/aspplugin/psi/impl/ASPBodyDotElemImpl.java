...
public class ASPBodyDotElemImpl extends ASPCompositeElementImpl implements ASPBodyDotElem {

  public ASPBodyDotElemImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ASPVisitor visitor) {
    visitor.visitBodyDotElem(this);
  }
  ...
  @Override
  @Nullable
  public ASPLuBodyAggregate getLuBodyAggregate() {
    return findChildByClass(ASPLuBodyAggregate.class);
  }
