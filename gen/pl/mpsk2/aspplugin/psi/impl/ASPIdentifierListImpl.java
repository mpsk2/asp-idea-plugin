...
public class ASPIdentifierListImpl extends ASPCompositeElementImpl implements ASPIdentifierList {

  public ASPIdentifierListImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<ASPIdentifier> getIdentifierList() {
    return ASPPsiTreeUtil.getChildrenOfTypeAsList(this, ASPIdentifier.class);
  }
