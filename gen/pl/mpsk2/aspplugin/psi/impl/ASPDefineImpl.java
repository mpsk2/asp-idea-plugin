...
public class ASPDefineImpl extends ASPCompositeElementImpl implements ASPDefine {

    public ASPDefineImpl(ASTNode node) {
        super(node);
    }
    ...
    public ASPConstantTerm getConstantTerm() {
        return findNotNullChildByClass(ASPConstantTerm.class);
    }
