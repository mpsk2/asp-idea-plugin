...
import pl.mpsk2.aspplugin.psi.impl.term.ASPTermImpl;
...
public class ASPTheoryTermImpl extends ASPTermImpl implements ASPTheoryTerm {

    public ASPTheoryTermImpl(ASTNode node) {
        super(node);
    }

    public void accept(@NotNull ASPVisitor visitor) {
        visitor.visitTheoryTerm(this);
    }
