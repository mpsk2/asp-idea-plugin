...
public class ASPNCspVecImpl extends ASPCompositeElementImpl implements ASPNCspVec {

  public ASPNCspVecImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ASPVisitor visitor) {
    visitor.visitNCspVec(this);
  }
  ...
  @Override
  @NotNull
  public List<ASPNCspElem> getNCspElemList() {
    return ASPPsiTreeUtil.getChildrenOfTypeAsList(this, ASPNCspElem.class);
  }
