...
public class ASPAltBodyAggrElemImpl extends ASPCompositeElementImpl implements ASPAltBodyAggrElem {

  public ASPAltBodyAggrElemImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ASPVisitor visitor) {
    visitor.visitAltBodyAggrElem(this);
  }
