...
public class ASPVBarConstantTermImpl extends ASPConstantTermImpl implements ASPVBarConstantTerm {

  public ASPVBarConstantTermImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ASPVisitor visitor) {
    visitor.visitVBarConstantTerm(this);
  }
