...
public class ASPTheoryAtomElementListImpl extends ASPCompositeElementImpl implements ASPTheoryAtomElementList {

    public ASPTheoryAtomElementListImpl(ASTNode node) {
        super(node);
    }

    public void accept(@NotNull ASPVisitor visitor) {
        visitor.visitTheoryAtomElementList(this);
    }
    ...
    @Override
    @NotNull
    public List<ASPTheoryAtomElement> getTheoryAtomElementList() {
        return ASPPsiTreeUtil.getChildrenOfTypeAsList(this, ASPTheoryAtomElement.class);
    }
