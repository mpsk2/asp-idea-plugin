...
public class ASPTheoryRootImpl extends ASPCompositeElementImpl implements ASPTheoryRoot {

    public ASPTheoryRootImpl(ASTNode node) {
        super(node);
    }

    public void accept(@NotNull ASPVisitor visitor) {
        visitor.visitTheoryRoot(this);
    }
    ...
    @Override
    @Nullable
    public ASPTheoryDefinitionVec getTheoryDefinitionVec() {
        return findChildByClass(ASPTheoryDefinitionVec.class);
    }
